package org.akarki.worldgdp.dao.mapper;

import org.akarki.worldgdp.model.City;
import org.akarki.worldgdp.model.Country;
...
/**
 * As we are using the JDBC Template, we need a way to map the rows of data from a database to a Java object.
 * This can be achieved by implementing a interface RowMapper
 */
